        ...
        try:
            with self.db_manager.get_session() as session:
                ...
                detection_event = DetectionEvent(
                    ...
                    bounding_box_x=getattr(detection.bounding_box, 'x', detection.bounding_box.get('x', 0) if hasattr(detection.bounding_box, 'get') else 0),
                    bounding_box_y=getattr(detection.bounding_box, 'y', detection.bounding_box.get('y', 0) if hasattr(detection.bounding_box, 'get') else 0),
                    bounding_box_width=getattr(detection.bounding_box, 'width', detection.bounding_box.get('width', 0) if hasattr(detection.bounding_box, 'get') else 0),
                    bounding_box_height=getattr(detection.bounding_box, 'height', detection.bounding_box.get('height', 0) if hasattr(detection.bounding_box, 'get') else 0),
